...
if __name__ == "__main__":
    ...
    trainer.train_on_epigenetic_code, trainer.validation_on_epigenetic_code,
    trainer.train_off_epigenetic_code, trainer.validation_off_epigenetic_code) = train_test_split(
        HEK_features, HEK_feature_ont, HEK_feature_offt, HEK_labels, HEK_on_epi, HEK_off_epi,
        test_size=0.2, stratify=HEK_labels, random_state=42)
